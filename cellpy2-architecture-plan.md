...
| Stage 3 — 2.0 assembly | 🟡 in progress (12 of 18 merged, 2026-07-19) | 18 issues on the `v2.0.0` milestone, tracking [#575](https://github.com/jepegit/cellpy/issues/575); scope decision (2 of 4 redesigns in 2.0) in [stage3-github-issues.md](stage3-github-issues.md). Merged: #210, #558, #559, #560 (part 1), #562, #563, #564, #565, #566, #568, #571, #569 (groundwork), plus the #580 fix and the cellpycore 0.2.3 re-pin. Open: #560 switchover, #561, #567, #569 cutover, #570, #572–#574 |
